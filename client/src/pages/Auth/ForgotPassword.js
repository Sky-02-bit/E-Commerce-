...
const ForgotPassword = () => {
    ...
    return (
        <Layout title={"Forgot Password - Sky Electron"}>
            <div className='form-container'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputPassword1" placeholder='Enter your favourit game' required />
                    </div>
